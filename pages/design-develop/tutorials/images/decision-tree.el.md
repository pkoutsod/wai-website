...
Αυτό το δέντρο αποφάσεων περιγράφει τον τρόπο χρήσης του χαρακτηριστικού `alt` του `<img>` στοιχείου σε διάφορες καταστάσεις. Για ορισμένους τύπους εικόνων, υπάρχουν εναλλακτικές προσεγγίσεις, όπως η χρήση εικόνων φόντου μέσω CSS για διακοσμητικές εικόνες ή γραμματοσειρές ιστού (web fonts) αντί για εικόνες με κείμενο.
